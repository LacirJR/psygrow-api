...
type AnamneseField struct {
	...
	FieldType     string                `gorm:"type:varchar(50);not null"` // date, datetime, text, number, checkbox, select, multiselect
	...
	Options       []AnamneseFieldOption `gorm:"foreignKey:AnamneseFieldID"`
